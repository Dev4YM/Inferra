    ...
    async def chat(
        ...
        *,
        ...
        if not content.strip():
            raise OllamaResponseError("Ollama chat response contained empty message.content")
        return content
    ...
    async def generate(
        ...
        *,
        ...
        if not response.strip():
            raise OllamaResponseError("Ollama generate response contained an empty response")
        return response
